...
<title><?php echo ($vo["sitename"]); ?></title>
...
<div class="row" style="margin-top:50px;">
  <div id="box" class="col-xs-3" style="float:none; margin-left:auto; margin-right:auto;">
	<div class="row" style="margin-top:50px;">
		<form name="loginForm" method="post" action="<?php echo U('home/public/checkLogin/');?>">
			  ...
			  <div class="form-group">
				 <div class="row">
				 <div class="col-xs-5">
				 <input type="text" name="verify" maxlength="4"  class="form-control input-lg"
				 placeholder="验证码" />
				 </div>
				 <div class="col-xs-7"><img class="code" id="verifyImg" style="height:42px;" src="<?php echo U('home/public/verify/');?>" onclick="this.src+='&rand=' + Math.random();" alt="点击刷新验证码" /> <a href="#" id="loadimg">看不清?</a>
				 </div>
				 </div>
			  </div>
			  <div class="form-group">
			  <input type="submit" class="btn btn-primary btn-block btn-lg" value="登录"/>
			  <a href="<?php echo U('home/public/reg/');?>">没有卡号？在线注册</a>			  
			  <p class="info"></p>
			  </div>
		</form>
	</div>
